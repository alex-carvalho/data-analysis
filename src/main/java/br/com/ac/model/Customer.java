...
public class Customer implements Model {
    ...
    public static Customer of(CNPJ cnpj, String name, String businessArea) {
        ...
        Objects.requireNonNull(businessArea, "businessArea can not be null!");
        if (name.trim().isEmpty()) throw new IllegalArgumentException("Customer name can not be empty!");
        if (businessArea.trim().isEmpty())
            throw new IllegalArgumentException("Customer business area can not be empty!");
